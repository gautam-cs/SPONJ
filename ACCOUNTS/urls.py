...
urlpatterns = [
                  ...
                  url(r'^runcode$', views.run_code, name='studentlist'),
                  url(r'^studentcourse/(?P<cid>([A-Za-z0-9]+))/$', views.student_course, name='student_course'),
                  url(r'^viewassignment_student/(?P<asid>([A-Za-z0-9]+))/$', views.view_assignment_student,
                      name='view_assignment_stud'),
                  url(r'^viewquestion_student/(?P<aid_qid>([A-Za-z0-9_]+))/$', views.view_question_student,
                      name='view_question'),
                  url(r'^viewassignmentwisereport_student/(?P<aid>([A-Za-z0-9]+))/$', views.view_report_wise_student,
                  ...
                  url(r'^activation_page$', views.activation_page, name='activation_page'),
                  ...
                  url(r'^createassignment_q/(?P<cid>([A-Za-z0-9]+))/$', views.createassignment_and_add_q,
                      name='createassignmentwithq'),
                  ...
                  url(r'^viewsubmission/(?P<subid>([A-Za-z0-9]+))/$', views.view_submission,
                      name='view_submissionprof'),
                  url(r'^studentvsquestion_matrix/(?P<asid>([A-Za-z0-9]+))/$', views.studentvsques_matrix,
                      name='view_studentvsquestion_matrix'),
                  ...
                  url(r'^assistant_register/(?P<cid>([A-Za-z0-9_]+))/$', views.assistant_register,
                      name='assistant_register'),
